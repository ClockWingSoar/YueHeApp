...
--
-- Host: 127.0.0.1    Database: yuehe-prod
-- ------------------------------------------------------
...
INSERT INTO `beautifyskinitem` VALUES ('xm001','表皮斑',4150,'一般是24900 6次，单价算下来为4150'),('xm002','真皮斑',4967,'一般是29800 6次，单价算下来为4967'),('xm003','代谢',4150,'一般是24900 6次，单价算下来为4150'),('xm004','混合斑',4967,'一般是29800 6次，单价算下来为4967，混合斑即为表皮斑+真皮斑'),('xm005','花青素',1000,'花青素属于产品，也可算作美肤项目的一种'),('xm006','水光',2419,'水光的价格应该和表皮斑差不多'),('xm007','线雕',2343,'test'),('xm008','疣',300,'一般是包年'),('xm009','点痣',3432,'包年为主'),('xm010','面膜',200,'补水保湿'),('xm011','无针水光',10000,'补水保湿'),('xm012','黄褐斑',4967,'黄褐斑为活性斑建议长期管理'),('xm013','黄褐斑代谢',3300,'黄褐斑代谢建议长期保养'),('xm014','至尊水雕',3300,'有利于细胞活力与色素代谢'),('xm015','黄气暗哑',3300,'此项目可做日常保养，辅助各类斑的治疗');
...
-- Dump completed on 2019-08-10 14:08:23

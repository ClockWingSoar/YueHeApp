...
echo.
echo 🌐 启动前端服务 (Next.js) - 端口3010...
cd frontend
echo 📝 前端服务将在新窗口中启动...
start "YueHe Frontend - Next.js" cmd /k "echo 启动YueHe前端服务... && echo API地址: http://localhost:8090/api && echo 端口: 3010 && echo. && npm run dev -- -p 3010"
cd ..
